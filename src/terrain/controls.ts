...
export function normalizeTerrainGenerationControls(
  ...
  return {
    ...
    provincePassageElevation: clamp(
      Math.round(readNumber(controls.provincePassageElevation, defaults.provincePassageElevation)),
      0,
      32
    ),
    ...
    provinceSmallIslandMultiplier: clamp(
      readNumber(controls.provinceSmallIslandMultiplier, defaults.provinceSmallIslandMultiplier),
      0,
      1
    ),
    provinceArchipelagoMultiplier: clamp(
      readNumber(controls.provinceArchipelagoMultiplier, defaults.provinceArchipelagoMultiplier),
      0,
      1
    ),
    provinceIslandSingleMultiplier: clamp(
      readNumber(controls.provinceIslandSingleMultiplier, defaults.provinceIslandSingleMultiplier),
      1,
      3
    ),
    provinceArchipelagoRadiusMultiplier: clamp(
      readNumber(controls.provinceArchipelagoRadiusMultiplier, defaults.provinceArchipelagoRadiusMultiplier),
      1,
      6
    ),
    ...
    ridgeContinuityThreshold: clamp(
      readNumber(controls.ridgeContinuityThreshold, defaults.ridgeContinuityThreshold),
      0,
      1
    ),
...
export function fingerprintTerrainGenerationControls(controls: TerrainGenerationControls): string {
