...
import { TerrainLocationComponent, TerrainRouteComponent, ActorComponent } from './ecs/components';
...
export class RoomDurableObject implements DurableObject
{
	...
	{
		//TODO: in future we want to create 4-6 factions then on connection player will take over one of the factions
		let numActors = 12;
		...
		{
			const spawnFace = this.pickSpawnFace("actor" + i);
			if (spawnFace === null)
			{
				continue;
			}
			nextActors.set("house" + i % 4, {
				actorId: "actor" + i,
				ownerId: "house" + i % 4,
				currentFace: spawnFace,
				targetFace: null,
