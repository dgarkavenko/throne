...
async function startClient() {
    ...
    engine.setVoronoiControls(terrainSettings.spacing, terrainSettings.showGraphs, terrainSettings.seed, terrainSettings.waterLevel, terrainSettings.waterRoughness);
    layout.onTerrainSettingsChange((nextSettings) => {
        engine.setVoronoiControls(nextSettings.spacing, nextSettings.showGraphs, nextSettings.seed, nextSettings.waterLevel, nextSettings.waterRoughness);
    });
